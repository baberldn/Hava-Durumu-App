...
export default function App() {
  const weatherData = [
    ...
    },
    {
      ...
      highTemp: 15,
      icon: "🌧️",
      background: "yağmurlu-background"
    },
    {
      id: 2,
      day: "Çarşamba",
  ...
  const { day, condition, lowTemp, highTemp, icon, background } = weatherData[currentDay];
